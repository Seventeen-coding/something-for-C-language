...
static const void *_getcontent(Subject *this_subject);
...
int inherit_Subject(Subject *subject)
{
    ...
    subject->setcontent = (setcontent_func)_setcontent;
    subject->getcontent = (getcontent_func)_getcontent;
    subject->reg_observer = (register_func)_register;
    subject->notifyAllObservers = (notify_func)_notify;
    return 0;
}
